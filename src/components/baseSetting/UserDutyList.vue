              ...
              <el-container>
                 <el-header style="height:auto;">
                     <el-row :gutter="20" class="searchcontent">
                       <el-input  placeholder="请输入职务名称" suffix-icon="el-icon-search" style="width:230px;"  @change="keyWordsInput"></el-input>
                       <span style="float:right;">  
                            <el-button type="primary" round icon="iconfont icon-zengjia"  @click="skip('edituserduty',0)"   v-hasButton name="memberdutylist:edit">新增职务</el-button>
                 ...
                 <el-main>
                      <el-table :data="tableData.list==null?[]:tableData.list" style="width: 100%" :header-cell-style="{textAlign:'center'}" 
                        :cell-style="{textAlign:'center',color:'#606266',padding:'4px 0'}"  :row-style="{height:'55px'}">
                          <el-table-column prop="dutyName" label="职务" min-width="100" align="center"  @change="keyWordsInput"></el-table-column>
                          <el-table-column label="管理操作" align="center">
                            <template slot-scope="scope">
                              <el-button  @click="skip('edituserduty',scope.row.dutyId)" class="editbtn"   v-hasButton name="memberdutylist:edit"></el-button>
                              <el-button @click="delDuty(scope.$index,scope.row)" class="deletebtn"   v-hasButton name="memberdutylist:delete"></el-button>
                            </template>
                          </el-table-column>
                      </el-table>
