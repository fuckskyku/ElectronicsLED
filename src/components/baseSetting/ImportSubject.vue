<template>
	<div id="app">
      ...
      <el-aside class="nav" style="width:100%">
        ...
        <el-breadcrumb-item to="/basesettingindex">学校信息管理</el-breadcrumb-item>
      ...
      <div id="importStudent" class="editInfo">           
        <el-form ref="ruleForm" :model="form" label-width="280px" style="padding-left:400px;padding-top:7%;">
            <el-form-item label="导入文件:">
                  <el-upload class="upload-demo" :headers="headers" style="height: 40px" ref="upload" name="file" action="/api/admin/editImportSubject" :on-change="fileChange" :before-upload="beforeAvatarUploadFile" :on-success="handleAvatarSuccessFile" :show-file-list="false" :auto-upload='false'  :multiple="false">
                  ...
                  <div>
                      <a href="http://dzbp.mseenet.com/uploads/template/subjectInfotemp.xls" download="科目模板">下载科目模板</a>
                  </div>
            </el-form-item>
