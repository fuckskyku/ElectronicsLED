<template>
	<div id="app">
      ...
      <div id="editUserInfo" class="editInfo">           
        <el-form ref="ruleForm" :model="form" label-width="280px" style="padding-left:30%;padding-top:7%;">
            <el-form-item label="导入文件:">
          <el-upload class="upload-demo" :headers="headers" style="height: 40px" ref="upload" name="file" action="/api/admin/editImportBuilding" :on-change="fileChange" :before-upload="beforeAvatarUploadFile" :on-success="handleAvatarSuccessFile" :show-file-list="false" :auto-upload='false'  :multiple="false">
          ...
          <span class="tips" v-if="fileFlag" style="color: #0ACF83;width: 100px;"><i class="el-icon-success"></i> 选择成功</span>
              ...
              <div>
                  <a href="http://dzbp.mseenet.com/uploads/template/BuildingInfotemp.xls" download="学生导入模板">下载教室模板</a>
              </div>
        </el-form-item>
