<template>
 <div id="login">
				<div class="login-form">
					<div class="login-header"><img src="/static/img/logo2.png" height="223" width="100%" alt="">
					</div>
			    <el-form ref="form" :model="form"  :rules="rules" :inline="true" label-width="80px"  class="demo-form-inline ">
					<el-form-item class="input-warp" prop="name">
            <img src="/static/img/usericon1.png" alt="">
						<el-input v-model="form.name" clearable placeholder="用户名/手机号" autocomplete="on"></el-input>
					</el-form-item>
					<el-form-item class="input-warp" prop="pass">
            <img src="/static/img/Password-icon1.png" alt="">
            ...
            login({ Name: this.form.name, password: this.form.pass }).then(
              res => {
                if(res.data.code == 200){
                  ...
                  if(res.data.data.userType == 2 || res.data.data.userType == 3){
                    //存储token
