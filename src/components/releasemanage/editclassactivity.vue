    ...
    <main>
      <el-aside class="nav" style="width:100%">
        <el-breadcrumb separator-class="el-icon-arrow-right">
          ...
          <el-breadcrumb-item to="/classactivitylist">班级活动</el-breadcrumb-item>
      ...
      <div class="editInfo">
        <el-form ref="form" :model="form" label-width="280px">
          ...
          <el-form-item style="text-align:center;">
            <el-button type="primary" @click="onSubmit('form')" class="submit" v-hasButton name="memberclassactivitylist:edit">保存</el-button>
            <el-button class="cancel" type="info" @click="skip('classactivitylist')">取消</el-button>
          </el-form-item>
        </el-form>
      </div>
    </main>
...
export default {
  ...
  created() {
    ...
    if (this.newsId > 0) {
      getClassactivityDetail({ id: this.newsId }).then(res => {
